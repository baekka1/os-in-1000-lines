...
struct process *create_process(const void *image, size_t image_size) {
	...
	// Stack callee-saved registers. These registers will be restored
...
void yield(void) {
	...
	// if theres no runnable process other than the current one, return and
	// continue processing
...
// NOTE: changed from bool to book
book virtq_is_busy(struct virtio_virtq *vq) {
